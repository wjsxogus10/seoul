...
def load_and_merge_data():
    ...
    # (B) 모든 데이터 컬럼 초기화 (KeyError 방지)
    # gdf에 없는 컬럼을 미리 추가하고 0으로 채움
    ...
    # 6. 대중교통 밀도 & 교통 부족 순위 계산 (KeyError 방지됨)
